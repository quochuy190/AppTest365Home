...
public class BXH {
    ...
    private static BXH getObject (JSONObject jsonObject){
        return new Gson().fromJson(jsonObject.toString(),BXH.class);
    }

    public  static ArrayList<BXH> getList(String jsonArray) throws JSONException {
        ArrayList<BXH> arrayList = new ArrayList<>();
        Type type = new TypeToken<List<BXH>>(){}.getType();
        Gson gson= new Gson();
