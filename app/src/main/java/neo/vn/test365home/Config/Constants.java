package neo.vn.test365home.Config;
...
public class Constants {
    ...
    public class RequestCode {
        ...
        public static final int GET_SCHOOLS = 10002;
        ...
        public static final int GET_YEAR = 10006;
        public static final int GET_DOWNLOAD_APPKID = 10007;
        public static final int GET_ADD_SUBUSER = 10008;
    ...
    public static final String KEY_THANKS_WELCOM = "KEY_THANKS_WELCOM";
    ...
    public static final String KEY_SEND_CHILDREN = "KEY_SEND_CHILDREN";
    public static final String KEY_SEND_CHILDREN_FRAGMENT = "KEY_SEND_CHILDREN_FRAGMENT";
    public static final String KEY_SEND_OBJECTIVE = "KEY_SEND_OBJECTIVE";
    ...
    public static final String KEY_SEND_TYPE_EXERCISE = "KEY_SEND_TYPE_EXERCISE";
    public static final String KEY_SAVE_PROMOTIONCODE = "KEY_SAVE_PROMOTIONCODE";
    public static final String KEY_SEND_ADD_ADDSUBUSER = "KEY_SEND_ADD_ADDSUBUSER";
